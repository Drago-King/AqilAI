...
public class AqilOverlayService extends Service {
    private WindowManager wm; private LinearLayout bubble; private long downAt; private SpeechRecognizer recognizer;
    ...
    private void showBubble() {
        ...
        EditText keyboard = new EditText(this); keyboard.setHint("Type command"); keyboard.setTextColor(getColor(R.color.aqil_text)); keyboard.setHintTextColor(getColor(R.color.aqil_muted)); keyboard.setSingleLine(true); keyboard.setVisibility(View.GONE); bubble.addView(keyboard);
        ...
        keyboard.setOnEditorActionListener((v, actionId, event) -> { AqilAccessibilityService.runCommand(v.getText().toString()); return true; });
    ...
    private void listen() {
        ...
        recognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle results) { ArrayList<String> r = results.getStringArrayList(SpeechRecognizer.RESULTS_RECOGNITION); if (r != null && !r.isEmpty()) AqilAccessibilityService.runCommand(r.get(0)); }
